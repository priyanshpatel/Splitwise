        ...
        if (cookie.load('cookie')) {
            ...
            navLogin = (
                <nav class="navbar navbar-light bg-light">
                    <a class="nav-link landing-link" href="#" style={{ color: "#59cfa7" }}><strong>Login</strong></a>
                    <a class="btn btn-primary" type="button" style={{ backgroundColor: "#59cfa7", border: "none" }}>Sign up</a>
                </nav>
            )
        }
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    <div class="container">
                        <a class="navbar-brand" href="#">
                            ...
                            <img src={splitwise_logo} width="40" height="40" class="d-inline-block align-top" alt="" />
